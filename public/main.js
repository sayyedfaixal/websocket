...
function sendMessage() {
  ...
  //   After sending the message Empty the Input field
  messageInput.value = "";
}
...
function addMessageToUI(isOwnMessage, data) {
  ...
  messageContainer.innerHTML += elemet;
  scrollToBottom();
}

// after sending the message it will scroll to Bottom
